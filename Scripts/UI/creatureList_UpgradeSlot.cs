...
public class CreatureList_UpgradeSlot : MonoBehaviour, IPointerClickHandler
{
    ...
    {
        CreatureList_UpgradeSlotController.Instance.SetFrameFocus(this);
        CreatureList_UpgradeSlotController.Instance.currentSlotNum = slotNum;
        Creature_Info_UI.Instance.CreatureDataSet(slotNum);
    }
}
